...
if(WIN32)
    ...
    MESSAGE(STATUS "CPLEX: root folder ${CPLEX_ROOT_DIR}")
...
if(UNIX)
    set(CPLEX_ROOT_DIR "/opt/ibm/ILOG/CPLEX_Studio128")
...
FIND_LIBRARY(CPLEX_LIBRARY
        NAMES cplex${CPLEX_WIN_VERSION} cplex cplex1280
...
if(WIN32)
    FIND_PATH(CPLEX_BIN_DIR
            ...
            ${CPLEX_ROOT_DIR}/cplex/bin/x64_win64
            )
else()
    FIND_PATH(CPLEX_BIN_DIR
            cplex
